  ...
  for (const field of requiredFields) {
    ...
    if (!req.body[posted]) {
      if (field === 'relationship.account_opener.address.line2' ||
          ...
          field === 'relationship.account_opener.verification.document.front' ||
          field === 'relationship.account_opener.verification.document.back' ||
          field === 'relationship.account_opener.verification.additional_document.front' ||
          field === 'relationship.account_opener.verification.additional_document.back') {
        continue
      }
