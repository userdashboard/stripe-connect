...
describe(`/account/connect/create-company-director`, async () => {
  ...
  describe('CreateCompanyDirector#POST', () => {
    it('should require each field', async () => {
      ...
      req.session = user.session
      const fields = [
        'relationship_director_verification_front',
        'relationship_director_verification_back'
      ]
    ...
    it('should require a document id front upload', async () => {
      ...
      const messageContainer = doc.getElementById('message-container')
      const message = messageContainer.child[0]
      assert.strictEqual(message.attr.template, 'invalid-relationship_director_verification_front')
    })
    ...
    it('should require a document id back upload', async () => {
      ...
      const messageContainer = doc.getElementById('message-container')
      const message = messageContainer.child[0]
      assert.strictEqual(message.attr.template, 'invalid-relationship_director_verification_back')
    })
