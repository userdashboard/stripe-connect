...
async function submitForm (req, res) {
  ...
  if (req.data.stripeAccount.requirements.currently_due.indexOf('verification.document.front') > -1) {
    if (!req.uploads || (
  ...
  if (req.data.stripeAccount.requirements.currently_due.indexOf('verification.additional_document.front') > -1) {
    if (!req.uploads || (
