...
module.exports = {
  post: async (req) => {
    ...
    if (req.uploads && req.uploads['relationship_director_verification_front']) {
      const frontData = {
        purpose: 'identity_document',
        file: {
          type: 'application/octet-stream',
          name: req.uploads['relationship_director_verification_front'].name,
          data: req.uploads['relationship_director_verification_front'].buffer
        }
      }
      try {
        ...
        throw new Error('invalid-relationship_director_verification_front')
      }
    } else {
      throw new Error('invalid-relationship_director_verification_front')
    }
    if (req.uploads && req.uploads['relationship_director_verification_back']) {
      const backData = {
        purpose: 'identity_document',
        file: {
          type: 'application/octet-stream',
          name: req.uploads['relationship_director_verification_back'].name,
          data: req.uploads['relationship_director_verification_back'].buffer
        }
      }
      try {
        ...
        throw new Error('invalid-relationship_director_verification_back')
      }
    } else {
      throw new Error('invalid-relationship_director_verification_back')
    }
